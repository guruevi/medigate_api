...
class ValidatingCompoundQueryFilterVulnerableDevice(BaseModel):
    """
    ...
    operands: conlist(ValidatingCompoundQueryFilterVulnerableDeviceOperandsInner) = Field(..., description="Other filters to join together using `operation`")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingCompoundQueryFilterVulnerableDevice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingCompoundQueryFilterVulnerableDevice:
        """Create an instance of ValidatingCompoundQueryFilterVulnerableDevice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingCompoundQueryFilterVulnerableDevice.parse_obj(obj)

        _obj = ValidatingCompoundQueryFilterVulnerableDevice.parse_obj({
            "operation": obj.get("operation"),
            "operands": [ValidatingCompoundQueryFilterVulnerableDeviceOperandsInner.from_dict(_item) for _item in obj.get("operands")] if obj.get("operands") is not None else None
        })
        return _obj
...
ValidatingCompoundQueryFilterVulnerableDevice.update_forward_refs()
