...
from medigate_api.models.validating_compound_query_filterserver_interfaces import ValidatingCompoundQueryFilterserverInterfaces  # noqa: E501

class TestValidatingCompoundQueryFilterserverInterfaces(unittest.TestCase):
    """ValidatingCompoundQueryFilterserverInterfaces unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterserverInterfaces:
        """Test ValidatingCompoundQueryFilterserverInterfaces
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterserverInterfaces`
        """
        model = ValidatingCompoundQueryFilterserverInterfaces()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterserverInterfaces(
                operation = 'and',
                operands = [
                    null
                    ]
    ...
    def testValidatingCompoundQueryFilterserverInterfaces(self):
        """Test ValidatingCompoundQueryFilterserverInterfaces"""
