...
from medigate_api.models.validating_sort_clause_device import ValidatingSortClauseDevice  # noqa: E501

class TestValidatingSortClauseDevice(unittest.TestCase):
    """ValidatingSortClauseDevice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSortClauseDevice:
        """Test ValidatingSortClauseDevice
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSortClauseDevice`
        """
        model = ValidatingSortClauseDevice()  # noqa: E501
        if include_optional:
            return ValidatingSortClauseDevice(
                field = 'network_list',
                order = 'asc'
            )
        else:
    ...
    def testValidatingSortClauseDevice(self):
        """Test ValidatingSortClauseDevice"""
