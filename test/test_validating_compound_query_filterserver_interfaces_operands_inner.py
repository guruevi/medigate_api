...
from medigate_api.models.validating_compound_query_filterserver_interfaces_operands_inner import ValidatingCompoundQueryFilterserverInterfacesOperandsInner  # noqa: E501

class TestValidatingCompoundQueryFilterserverInterfacesOperandsInner(unittest.TestCase):
    """ValidatingCompoundQueryFilterserverInterfacesOperandsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterserverInterfacesOperandsInner:
        """Test ValidatingCompoundQueryFilterserverInterfacesOperandsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterserverInterfacesOperandsInner`
        """
        model = ValidatingCompoundQueryFilterserverInterfacesOperandsInner()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterserverInterfacesOperandsInner(
                field = None,
                operation = 'and',
                value = None,
                operands = None
    ...
    def testValidatingCompoundQueryFilterserverInterfacesOperandsInner(self):
        """Test ValidatingCompoundQueryFilterserverInterfacesOperandsInner"""
