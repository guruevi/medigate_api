...
class AlertedDeviceSortableFieldsEnum(str, Enum):
    """
    An enumeration.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertedDeviceSortableFieldsEnum:
        """Create an instance of AlertedDeviceSortableFieldsEnum from a JSON string"""
        return AlertedDeviceSortableFieldsEnum(json.loads(json_str))
