...
class ValidatingSortClauseDevice(BaseModel):
    """
    ValidatingSortClauseDevice
    """
    field: DeviceSortableFieldsEnum = Field(..., description="Name of field to sort by")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingSortClauseDevice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingSortClauseDevice:
        """Create an instance of ValidatingSortClauseDevice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingSortClauseDevice.parse_obj(obj)

        _obj = ValidatingSortClauseDevice.parse_obj({
            "field": obj.get("field"),
            "order": obj.get("order")
        })
        return _obj
