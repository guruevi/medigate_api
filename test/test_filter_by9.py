...
from medigate_api.models.filter_by9 import FilterBy9  # noqa: E501

class TestFilterBy9(unittest.TestCase):
    """FilterBy9 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterBy9:
        """Test FilterBy9
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterBy9`
        """
        model = FilterBy9()  # noqa: E501
        if include_optional:
            return FilterBy9(
                field = None,
                operation = 'and',
