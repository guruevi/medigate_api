...
class ValidatingCompoundQueryFilterDeviceAlert(BaseModel):
    """
    ...
    operands: conlist(ValidatingCompoundQueryFilterDeviceAlertOperandsInner) = Field(..., description="Other filters to join together using `operation`")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingCompoundQueryFilterDeviceAlert:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingCompoundQueryFilterDeviceAlert:
        """Create an instance of ValidatingCompoundQueryFilterDeviceAlert from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingCompoundQueryFilterDeviceAlert.parse_obj(obj)

        _obj = ValidatingCompoundQueryFilterDeviceAlert.parse_obj({
            "operation": obj.get("operation"),
            "operands": [ValidatingCompoundQueryFilterDeviceAlertOperandsInner.from_dict(_item) for _item in obj.get("operands")] if obj.get("operands") is not None else None
        })
        return _obj
...
ValidatingCompoundQueryFilterDeviceAlert.update_forward_refs()
