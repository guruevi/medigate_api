...
VALIDATINGCOMPOUNDQUERYFILTERSERVERINTERFACESOPERANDSINNER_ANY_OF_SCHEMAS = ["ValidatingCompoundQueryFilterserverInterfaces", "ValidatingSimpleQueryFilterserverInterfaces"]

class ValidatingCompoundQueryFilterserverInterfacesOperandsInner(BaseModel):
    """
    ValidatingCompoundQueryFilterserverInterfacesOperandsInner
    """

    # data type: ValidatingSimpleQueryFilterserverInterfaces
    anyof_schema_1_validator: Optional[ValidatingSimpleQueryFilterserverInterfaces] = None
    # data type: ValidatingCompoundQueryFilterserverInterfaces
    anyof_schema_2_validator: Optional[ValidatingCompoundQueryFilterserverInterfaces] = None
    if TYPE_CHECKING:
        actual_instance: Union[ValidatingCompoundQueryFilterserverInterfaces, ValidatingSimpleQueryFilterserverInterfaces]
    else:
        actual_instance: Any
    any_of_schemas: List[str] = Field(VALIDATINGCOMPOUNDQUERYFILTERSERVERINTERFACESOPERANDSINNER_ANY_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ValidatingCompoundQueryFilterserverInterfacesOperandsInner.construct()
        error_messages = []
        # validate data type: ValidatingSimpleQueryFilterserverInterfaces
        if not isinstance(v, ValidatingSimpleQueryFilterserverInterfaces):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ValidatingSimpleQueryFilterserverInterfaces`")
        else:
            return v

        # validate data type: ValidatingCompoundQueryFilterserverInterfaces
        if not isinstance(v, ValidatingCompoundQueryFilterserverInterfaces):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ValidatingCompoundQueryFilterserverInterfaces`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ValidatingCompoundQueryFilterserverInterfacesOperandsInner with anyOf schemas: ValidatingCompoundQueryFilterserverInterfaces, ValidatingSimpleQueryFilterserverInterfaces. Details: " + ", ".join(error_messages))
        else:
            return v

    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingCompoundQueryFilterserverInterfacesOperandsInner:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> ValidatingCompoundQueryFilterserverInterfacesOperandsInner:
        """Returns the object represented by the json string"""
        instance = ValidatingCompoundQueryFilterserverInterfacesOperandsInner.construct()
        error_messages = []
        # anyof_schema_1_validator: Optional[ValidatingSimpleQueryFilterserverInterfaces] = None
        try:
            instance.actual_instance = ValidatingSimpleQueryFilterserverInterfaces.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[ValidatingCompoundQueryFilterserverInterfaces] = None
        try:
            instance.actual_instance = ValidatingCompoundQueryFilterserverInterfaces.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ValidatingCompoundQueryFilterserverInterfacesOperandsInner with anyOf schemas: ValidatingCompoundQueryFilterserverInterfaces, ValidatingSimpleQueryFilterserverInterfaces. Details: " + ", ".join(error_messages))
        else:
            return instance
...
ValidatingCompoundQueryFilterserverInterfacesOperandsInner.update_forward_refs()
