...
class GetAlertsResponse(BaseModel):
    ...
    GetAlertsResponse
    """
    alerts: conlist(Dict[str, Any]) = Field(...)
    count: Optional[StrictInt] = None
    __properties = ["alerts", "count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAlertsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAlertsResponse:
        """Create an instance of GetAlertsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAlertsResponse.parse_obj(obj)

        _obj = GetAlertsResponse.parse_obj({
