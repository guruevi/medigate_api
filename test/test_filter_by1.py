...
from medigate_api.models.filter_by1 import FilterBy1  # noqa: E501

class TestFilterBy1(unittest.TestCase):
    """FilterBy1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterBy1:
        """Test FilterBy1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterBy1`
        """
        model = FilterBy1()  # noqa: E501
        if include_optional:
            return FilterBy1(
                field = None,
                operation = 'and',
