...
class GetAlertedDevicesResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAlertedDevicesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAlertedDevicesResponse:
        """Create an instance of GetAlertedDevicesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAlertedDevicesResponse.parse_obj(obj)

        _obj = GetAlertedDevicesResponse.parse_obj({
