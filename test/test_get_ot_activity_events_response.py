...
from medigate_api.models.get_ot_activity_events_response import GetOTActivityEventsResponse  # noqa: E501

class TestGetOTActivityEventsResponse(unittest.TestCase):
    """GetOTActivityEventsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOTActivityEventsResponse:
        """Test GetOTActivityEventsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOTActivityEventsResponse`
        """
        model = GetOTActivityEventsResponse()  # noqa: E501
        if include_optional:
            return GetOTActivityEventsResponse(
                ot_activity_events = [
                    None
                    ],
                count = 56
    ...
    def testGetOTActivityEventsResponse(self):
        """Test GetOTActivityEventsResponse"""
