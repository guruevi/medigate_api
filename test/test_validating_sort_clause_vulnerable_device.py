...
from medigate_api.models.validating_sort_clause_vulnerable_device import ValidatingSortClauseVulnerableDevice  # noqa: E501

class TestValidatingSortClauseVulnerableDevice(unittest.TestCase):
    """ValidatingSortClauseVulnerableDevice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSortClauseVulnerableDevice:
        """Test ValidatingSortClauseVulnerableDevice
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSortClauseVulnerableDevice`
        """
        model = ValidatingSortClauseVulnerableDevice()  # noqa: E501
        if include_optional:
            return ValidatingSortClauseVulnerableDevice(
                field = 'network_list',
                order = 'asc'
            )
        else:
    ...
    def testValidatingSortClauseVulnerableDevice(self):
        """Test ValidatingSortClauseVulnerableDevice"""
