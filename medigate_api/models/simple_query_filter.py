...
class SimpleQueryFilter(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SimpleQueryFilter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SimpleQueryFilter:
        """Create an instance of SimpleQueryFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SimpleQueryFilter.parse_obj(obj)

        _obj = SimpleQueryFilter.parse_obj({
            "field": obj.get("field"),
