...
from medigate_api.models.validating_compound_query_filter_alerted_device_operands_inner import ValidatingCompoundQueryFilterAlertedDeviceOperandsInner  # noqa: E501

class TestValidatingCompoundQueryFilterAlertedDeviceOperandsInner(unittest.TestCase):
    """ValidatingCompoundQueryFilterAlertedDeviceOperandsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterAlertedDeviceOperandsInner:
        """Test ValidatingCompoundQueryFilterAlertedDeviceOperandsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterAlertedDeviceOperandsInner`
        """
        model = ValidatingCompoundQueryFilterAlertedDeviceOperandsInner()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterAlertedDeviceOperandsInner(
                field = None,
                operation = 'and',
                value = None,
                operands = None
    ...
    def testValidatingCompoundQueryFilterAlertedDeviceOperandsInner(self):
        """Test ValidatingCompoundQueryFilterAlertedDeviceOperandsInner"""
