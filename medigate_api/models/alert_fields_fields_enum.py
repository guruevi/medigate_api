...
class AlertFieldsFieldsEnum(str, Enum):
    """
    An enumeration.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertFieldsFieldsEnum:
        """Create an instance of AlertFieldsFieldsEnum from a JSON string"""
        return AlertFieldsFieldsEnum(json.loads(json_str))
