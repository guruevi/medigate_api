...
from medigate_api.models.filter_by7 import FilterBy7  # noqa: E501

class TestFilterBy7(unittest.TestCase):
    """FilterBy7 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterBy7:
        """Test FilterBy7
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterBy7`
        """
        model = FilterBy7()  # noqa: E501
        if include_optional:
            return FilterBy7(
                field = None,
                operation = 'and',
