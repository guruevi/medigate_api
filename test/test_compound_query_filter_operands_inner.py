...
from medigate_api.models.compound_query_filter_operands_inner import CompoundQueryFilterOperandsInner  # noqa: E501

class TestCompoundQueryFilterOperandsInner(unittest.TestCase):
    """CompoundQueryFilterOperandsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompoundQueryFilterOperandsInner:
        """Test CompoundQueryFilterOperandsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompoundQueryFilterOperandsInner`
        """
        model = CompoundQueryFilterOperandsInner()  # noqa: E501
        if include_optional:
            return CompoundQueryFilterOperandsInner(
                field = None,
                operation = 'and',
                value = None,
                operands = None
    ...
    def testCompoundQueryFilterOperandsInner(self):
        """Test CompoundQueryFilterOperandsInner"""
