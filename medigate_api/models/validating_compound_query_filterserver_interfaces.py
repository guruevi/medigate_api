...
class ValidatingCompoundQueryFilterserverInterfaces(BaseModel):
    """
    ...
    operands: conlist(ValidatingCompoundQueryFilterserverInterfacesOperandsInner) = Field(..., description="Other filters to join together using `operation`")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingCompoundQueryFilterserverInterfaces:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingCompoundQueryFilterserverInterfaces:
        """Create an instance of ValidatingCompoundQueryFilterserverInterfaces from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingCompoundQueryFilterserverInterfaces.parse_obj(obj)

        _obj = ValidatingCompoundQueryFilterserverInterfaces.parse_obj({
            "operation": obj.get("operation"),
            "operands": [ValidatingCompoundQueryFilterserverInterfacesOperandsInner.from_dict(_item) for _item in obj.get("operands")] if obj.get("operands") is not None else None
        })
        return _obj
...
ValidatingCompoundQueryFilterserverInterfaces.update_forward_refs()
