...
FILTERBY4_ANY_OF_SCHEMAS = ["ValidatingCompoundQueryFilterDeviceVulnerability", "ValidatingSimpleQueryFilterDeviceVulnerability"]

class FilterBy4(BaseModel):
    """
    ...
    # data type: ValidatingSimpleQueryFilterDeviceVulnerability
    anyof_schema_1_validator: Optional[ValidatingSimpleQueryFilterDeviceVulnerability] = None
    # data type: ValidatingCompoundQueryFilterDeviceVulnerability
    anyof_schema_2_validator: Optional[ValidatingCompoundQueryFilterDeviceVulnerability] = None
    if TYPE_CHECKING:
        actual_instance: Union[ValidatingCompoundQueryFilterDeviceVulnerability, ValidatingSimpleQueryFilterDeviceVulnerability]
    else:
        actual_instance: Any
    any_of_schemas: List[str] = Field(FILTERBY4_ANY_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = FilterBy4.construct()
        error_messages = []
        # validate data type: ValidatingSimpleQueryFilterDeviceVulnerability
        if not isinstance(v, ValidatingSimpleQueryFilterDeviceVulnerability):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ValidatingSimpleQueryFilterDeviceVulnerability`")
        else:
            return v

        # validate data type: ValidatingCompoundQueryFilterDeviceVulnerability
        if not isinstance(v, ValidatingCompoundQueryFilterDeviceVulnerability):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ValidatingCompoundQueryFilterDeviceVulnerability`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in FilterBy4 with anyOf schemas: ValidatingCompoundQueryFilterDeviceVulnerability, ValidatingSimpleQueryFilterDeviceVulnerability. Details: " + ", ".join(error_messages))
        else:
            return v

    @classmethod
    def from_dict(cls, obj: dict) -> FilterBy4:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> FilterBy4:
        """Returns the object represented by the json string"""
        instance = FilterBy4.construct()
        error_messages = []
        # anyof_schema_1_validator: Optional[ValidatingSimpleQueryFilterDeviceVulnerability] = None
        try:
            instance.actual_instance = ValidatingSimpleQueryFilterDeviceVulnerability.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[ValidatingCompoundQueryFilterDeviceVulnerability] = None
        try:
            instance.actual_instance = ValidatingCompoundQueryFilterDeviceVulnerability.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into FilterBy4 with anyOf schemas: ValidatingCompoundQueryFilterDeviceVulnerability, ValidatingSimpleQueryFilterDeviceVulnerability. Details: " + ", ".join(error_messages))
        else:
            return instance
