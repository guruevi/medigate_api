...
from medigate_api.models.validating_compound_query_filter_device import ValidatingCompoundQueryFilterDevice  # noqa: E501

class TestValidatingCompoundQueryFilterDevice(unittest.TestCase):
    """ValidatingCompoundQueryFilterDevice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterDevice:
        """Test ValidatingCompoundQueryFilterDevice
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterDevice`
        """
        model = ValidatingCompoundQueryFilterDevice()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterDevice(
                operation = 'and',
                operands = [
                    null
                    ]
    ...
    def testValidatingCompoundQueryFilterDevice(self):
        """Test ValidatingCompoundQueryFilterDevice"""
