...
class ServerInterfacesFieldsEnum(str, Enum):
    """
    An enumeration.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerInterfacesFieldsEnum:
        """Create an instance of ServerInterfacesFieldsEnum from a JSON string"""
        return ServerInterfacesFieldsEnum(json.loads(json_str))
