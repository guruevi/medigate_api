...
class ValidatingSortClauseserverInterfaces(BaseModel):
    """
    ValidatingSortClauseserverInterfaces
    """
    field: ServerInterfacesSortableFieldsEnum = Field(..., description="Name of field to sort by")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingSortClauseserverInterfaces:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingSortClauseserverInterfaces:
        """Create an instance of ValidatingSortClauseserverInterfaces from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingSortClauseserverInterfaces.parse_obj(obj)

        _obj = ValidatingSortClauseserverInterfaces.parse_obj({
            "field": obj.get("field"),
            "order": obj.get("order")
        })
        return _obj
