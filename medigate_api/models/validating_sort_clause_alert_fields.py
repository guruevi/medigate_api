...
class ValidatingSortClauseAlertFields(BaseModel):
    """
    ValidatingSortClauseAlertFields
    """
    field: AlertFieldsSortableFieldsEnum = Field(..., description="Name of field to sort by")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingSortClauseAlertFields:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingSortClauseAlertFields:
        """Create an instance of ValidatingSortClauseAlertFields from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingSortClauseAlertFields.parse_obj(obj)

        _obj = ValidatingSortClauseAlertFields.parse_obj({
            "field": obj.get("field"),
            "order": obj.get("order")
        })
        return _obj
