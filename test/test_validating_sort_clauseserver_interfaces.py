...
from medigate_api.models.validating_sort_clauseserver_interfaces import ValidatingSortClauseserverInterfaces  # noqa: E501

class TestValidatingSortClauseserverInterfaces(unittest.TestCase):
    """ValidatingSortClauseserverInterfaces unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSortClauseserverInterfaces:
        """Test ValidatingSortClauseserverInterfaces
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSortClauseserverInterfaces`
        """
        model = ValidatingSortClauseserverInterfaces()  # noqa: E501
        if include_optional:
            return ValidatingSortClauseserverInterfaces(
                field = 'server_name',
                order = 'asc'
            )
        else:
    ...
    def testValidatingSortClauseserverInterfaces(self):
        """Test ValidatingSortClauseserverInterfaces"""
