...
class GetDeviceAlertsResponse(BaseModel):
    """
    GetDeviceAlertsResponse
    """
    devices_alerts: conlist(Dict[str, Any]) = Field(...)
    count: Optional[StrictInt] = None
    __properties = ["devices_alerts", "count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDeviceAlertsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDeviceAlertsResponse:
        """Create an instance of GetDeviceAlertsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDeviceAlertsResponse.parse_obj(obj)

        _obj = GetDeviceAlertsResponse.parse_obj({
            "devices_alerts": obj.get("devices_alerts"),
            "count": obj.get("count")
        })
        return _obj
