...
class DeviceFieldsEnum(str, Enum):
    """
    An enumeration.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeviceFieldsEnum:
        """Create an instance of DeviceFieldsEnum from a JSON string"""
        return DeviceFieldsEnum(json.loads(json_str))
