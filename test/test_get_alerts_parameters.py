...
from medigate_api.models.get_alerts_parameters import GetAlertsParameters  # noqa: E501

class TestGetAlertsParameters(unittest.TestCase):
    """GetAlertsParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAlertsParameters:
        """Test GetAlertsParameters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAlertsParameters`
        """
        model = GetAlertsParameters()  # noqa: E501
        if include_optional:
            return GetAlertsParameters(
                filter_by = None,
                fields = [
                    'id'
                    ],
    ...
    def testGetAlertsParameters(self):
        """Test GetAlertsParameters"""
