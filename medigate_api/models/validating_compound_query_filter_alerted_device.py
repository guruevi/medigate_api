...
class ValidatingCompoundQueryFilterAlertedDevice(BaseModel):
    """
    ...
    operands: conlist(ValidatingCompoundQueryFilterAlertedDeviceOperandsInner) = Field(..., description="Other filters to join together using `operation`")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingCompoundQueryFilterAlertedDevice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingCompoundQueryFilterAlertedDevice:
        """Create an instance of ValidatingCompoundQueryFilterAlertedDevice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingCompoundQueryFilterAlertedDevice.parse_obj(obj)

        _obj = ValidatingCompoundQueryFilterAlertedDevice.parse_obj({
            "operation": obj.get("operation"),
            "operands": [ValidatingCompoundQueryFilterAlertedDeviceOperandsInner.from_dict(_item) for _item in obj.get("operands")] if obj.get("operands") is not None else None
        })
        return _obj
...
ValidatingCompoundQueryFilterAlertedDevice.update_forward_refs()
