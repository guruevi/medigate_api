...
class PublicNotesSet(BaseModel):
    """
    PublicNotesSet
    """
    target_specification: TargetSpecification = Field(...)
    note: StrictStr = Field(...)
    action: Optional[NoteAction] = None
    __properties = ["target_specification", "note", "action"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicNotesSet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublicNotesSet:
        """Create an instance of PublicNotesSet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublicNotesSet.parse_obj(obj)

        _obj = PublicNotesSet.parse_obj({
