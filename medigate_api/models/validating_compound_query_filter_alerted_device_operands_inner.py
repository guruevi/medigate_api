...
VALIDATINGCOMPOUNDQUERYFILTERALERTEDDEVICEOPERANDSINNER_ANY_OF_SCHEMAS = ["ValidatingCompoundQueryFilterAlertedDevice", "ValidatingSimpleQueryFilterAlertedDevice"]

class ValidatingCompoundQueryFilterAlertedDeviceOperandsInner(BaseModel):
    """
    ...
    if TYPE_CHECKING:
        ...
        actual_instance: Any
    any_of_schemas: List[str] = Field(VALIDATINGCOMPOUNDQUERYFILTERALERTEDDEVICEOPERANDSINNER_ANY_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ValidatingCompoundQueryFilterAlertedDeviceOperandsInner.construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ValidatingCompoundQueryFilterAlertedDeviceOperandsInner with anyOf schemas: ValidatingCompoundQueryFilterAlertedDevice, ValidatingSimpleQueryFilterAlertedDevice. Details: " + ", ".join(error_messages))
        else:
            return v

    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingCompoundQueryFilterAlertedDeviceOperandsInner:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> ValidatingCompoundQueryFilterAlertedDeviceOperandsInner:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ValidatingCompoundQueryFilterAlertedDeviceOperandsInner with anyOf schemas: ValidatingCompoundQueryFilterAlertedDevice, ValidatingSimpleQueryFilterAlertedDevice. Details: " + ", ".join(error_messages))
        else:
            return instance
...
ValidatingCompoundQueryFilterAlertedDeviceOperandsInner.update_forward_refs()
