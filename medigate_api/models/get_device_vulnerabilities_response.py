...
class GetDeviceVulnerabilitiesResponse(BaseModel):
    """
    GetDeviceVulnerabilitiesResponse
    """
    devices_vulnerabilities: conlist(Dict[str, Any]) = Field(...)
    count: Optional[StrictInt] = None
    __properties = ["devices_vulnerabilities", "count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDeviceVulnerabilitiesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDeviceVulnerabilitiesResponse:
        """Create an instance of GetDeviceVulnerabilitiesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDeviceVulnerabilitiesResponse.parse_obj(obj)

        _obj = GetDeviceVulnerabilitiesResponse.parse_obj({
            "devices_vulnerabilities": obj.get("devices_vulnerabilities"),
            "count": obj.get("count")
        })
        return _obj
