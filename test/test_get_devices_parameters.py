...
from medigate_api.models.get_devices_parameters import GetDevicesParameters  # noqa: E501

class TestGetDevicesParameters(unittest.TestCase):
    """GetDevicesParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDevicesParameters:
        """Test GetDevicesParameters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDevicesParameters`
        """
        model = GetDevicesParameters()  # noqa: E501
        if include_optional:
            return GetDevicesParameters(
                filter_by = None,
                fields = [
                    'network_list'
                    ],
    ...
    def testGetDevicesParameters(self):
        """Test GetDevicesParameters"""
