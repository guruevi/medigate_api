...
class GetServerInterfacesResponse(BaseModel):
    """
    GetServerInterfacesResponse
    """
    server_interfaces: conlist(Dict[str, Any]) = Field(...)
    count: Optional[StrictInt] = None
    __properties = ["server_interfaces", "count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetServerInterfacesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetServerInterfacesResponse:
        """Create an instance of GetServerInterfacesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetServerInterfacesResponse.parse_obj(obj)

        _obj = GetServerInterfacesResponse.parse_obj({
