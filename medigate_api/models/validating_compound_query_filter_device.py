...
class ValidatingCompoundQueryFilterDevice(BaseModel):
    """
    ...
    operands: conlist(ValidatingCompoundQueryFilterDeviceOperandsInner) = Field(..., description="Other filters to join together using `operation`")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingCompoundQueryFilterDevice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingCompoundQueryFilterDevice:
        """Create an instance of ValidatingCompoundQueryFilterDevice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingCompoundQueryFilterDevice.parse_obj(obj)

        _obj = ValidatingCompoundQueryFilterDevice.parse_obj({
            "operation": obj.get("operation"),
            "operands": [ValidatingCompoundQueryFilterDeviceOperandsInner.from_dict(_item) for _item in obj.get("operands")] if obj.get("operands") is not None else None
        })
        return _obj
...
ValidatingCompoundQueryFilterDevice.update_forward_refs()
