...
from medigate_api.models.filter_by12 import FilterBy12  # noqa: E501

class TestFilterBy12(unittest.TestCase):
    """FilterBy12 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterBy12:
        """Test FilterBy12
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterBy12`
        """
        model = FilterBy12()  # noqa: E501
        if include_optional:
            return FilterBy12(
                field = None,
                operation = 'and',
