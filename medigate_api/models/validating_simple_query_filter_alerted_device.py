...
class ValidatingSimpleQueryFilterAlertedDevice(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingSimpleQueryFilterAlertedDevice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingSimpleQueryFilterAlertedDevice:
        """Create an instance of ValidatingSimpleQueryFilterAlertedDevice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingSimpleQueryFilterAlertedDevice.parse_obj(obj)

        _obj = ValidatingSimpleQueryFilterAlertedDevice.parse_obj({
            "field": obj.get("field"),
