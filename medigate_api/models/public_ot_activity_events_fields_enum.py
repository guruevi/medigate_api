...
class PublicOtActivityEventsFieldsEnum(str, Enum):
    """
    An enumeration.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicOtActivityEventsFieldsEnum:
        """Create an instance of PublicOtActivityEventsFieldsEnum from a JSON string"""
        return PublicOtActivityEventsFieldsEnum(json.loads(json_str))
