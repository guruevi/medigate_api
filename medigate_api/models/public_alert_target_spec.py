...
class PublicAlertTargetSpec(BaseModel):
    """
    ...
    alert_ids: Optional[conlist(StrictInt)] = None
    __properties = ["target_type", "alert_ids"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicAlertTargetSpec:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublicAlertTargetSpec:
        """Create an instance of PublicAlertTargetSpec from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublicAlertTargetSpec.parse_obj(obj)

        _obj = PublicAlertTargetSpec.parse_obj({
