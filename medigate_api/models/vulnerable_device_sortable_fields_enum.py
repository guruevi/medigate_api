...
class VulnerableDeviceSortableFieldsEnum(str, Enum):
    """
    An enumeration.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VulnerableDeviceSortableFieldsEnum:
        """Create an instance of VulnerableDeviceSortableFieldsEnum from a JSON string"""
        return VulnerableDeviceSortableFieldsEnum(json.loads(json_str))
