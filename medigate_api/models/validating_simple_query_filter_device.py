...
class ValidatingSimpleQueryFilterDevice(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingSimpleQueryFilterDevice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingSimpleQueryFilterDevice:
        """Create an instance of ValidatingSimpleQueryFilterDevice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingSimpleQueryFilterDevice.parse_obj(obj)

        _obj = ValidatingSimpleQueryFilterDevice.parse_obj({
            "field": obj.get("field"),
