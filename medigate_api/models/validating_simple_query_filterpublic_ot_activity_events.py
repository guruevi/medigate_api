...
class ValidatingSimpleQueryFilterpublicOtActivityEvents(BaseModel):
    """
    A filter on a single column  # noqa: E501
    """
    field: constr(strict=True, min_length=1) = Field(..., description="Name of field to filter")
    operation: constr(strict=True, min_length=1) = Field(..., description="Type of filter on the field")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingSimpleQueryFilterpublicOtActivityEvents:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingSimpleQueryFilterpublicOtActivityEvents:
        """Create an instance of ValidatingSimpleQueryFilterpublicOtActivityEvents from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingSimpleQueryFilterpublicOtActivityEvents.parse_obj(obj)

        _obj = ValidatingSimpleQueryFilterpublicOtActivityEvents.parse_obj({
            "field": obj.get("field"),
