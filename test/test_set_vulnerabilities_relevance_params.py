...
from medigate_api.models.set_vulnerabilities_relevance_params import SetVulnerabilitiesRelevanceParams  # noqa: E501

class TestSetVulnerabilitiesRelevanceParams(unittest.TestCase):
    """SetVulnerabilitiesRelevanceParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetVulnerabilitiesRelevanceParams:
        """Test SetVulnerabilitiesRelevanceParams
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetVulnerabilitiesRelevanceParams`
        """
        model = SetVulnerabilitiesRelevanceParams()  # noqa: E501
        if include_optional:
            return SetVulnerabilitiesRelevanceParams(
                vulnerabilities = medigate_api.models.vulnerabilities_filter_by.VulnerabilitiesFilterBy(
                    filter_by = null, ),
                devices = medigate_api.models.devices_filter_by.DevicesFilterBy(
                    filter_by = null, ),
                relevance = 'confirmed'
            )
        else:
    ...
    def testSetVulnerabilitiesRelevanceParams(self):
        """Test SetVulnerabilitiesRelevanceParams"""
