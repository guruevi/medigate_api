...
from medigate_api.models.get_alerts_response import GetAlertsResponse  # noqa: E501
...
class TestGetAlertsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAlertsResponse:
        """Test GetAlertsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAlertsResponse`
        """
        model = GetAlertsResponse()  # noqa: E501
        if include_optional:
    ...
    def testGetAlertsResponse(self):
        """Test GetAlertsResponse"""
