...
from medigate_api.models.validating_compound_query_filter_alert_fields import ValidatingCompoundQueryFilterAlertFields  # noqa: E501

class TestValidatingCompoundQueryFilterAlertFields(unittest.TestCase):
    """ValidatingCompoundQueryFilterAlertFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterAlertFields:
        """Test ValidatingCompoundQueryFilterAlertFields
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterAlertFields`
        """
        model = ValidatingCompoundQueryFilterAlertFields()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterAlertFields(
                operation = 'and',
                operands = [
                    null
                    ]
    ...
    def testValidatingCompoundQueryFilterAlertFields(self):
        """Test ValidatingCompoundQueryFilterAlertFields"""
