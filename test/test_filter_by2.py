...
from medigate_api.models.filter_by2 import FilterBy2  # noqa: E501

class TestFilterBy2(unittest.TestCase):
    """FilterBy2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterBy2:
        """Test FilterBy2
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterBy2`
        """
        model = FilterBy2()  # noqa: E501
        if include_optional:
            return FilterBy2(
                field = None,
                operation = 'and',
