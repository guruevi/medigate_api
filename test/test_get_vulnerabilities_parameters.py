...
from medigate_api.models.get_vulnerabilities_parameters import GetVulnerabilitiesParameters  # noqa: E501

class TestGetVulnerabilitiesParameters(unittest.TestCase):
    """GetVulnerabilitiesParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVulnerabilitiesParameters:
        """Test GetVulnerabilitiesParameters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVulnerabilitiesParameters`
        """
        model = GetVulnerabilitiesParameters()  # noqa: E501
        if include_optional:
            return GetVulnerabilitiesParameters(
                filter_by = None,
                fields = [
                    'name'
                    ],
    ...
    def testGetVulnerabilitiesParameters(self):
        """Test GetVulnerabilitiesParameters"""
