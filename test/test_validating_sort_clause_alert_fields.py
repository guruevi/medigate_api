...
from medigate_api.models.validating_sort_clause_alert_fields import ValidatingSortClauseAlertFields  # noqa: E501

class TestValidatingSortClauseAlertFields(unittest.TestCase):
    """ValidatingSortClauseAlertFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSortClauseAlertFields:
        """Test ValidatingSortClauseAlertFields
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSortClauseAlertFields`
        """
        model = ValidatingSortClauseAlertFields()  # noqa: E501
        if include_optional:
            return ValidatingSortClauseAlertFields(
                field = 'id',
                order = 'asc'
            )
        else:
    ...
    def testValidatingSortClauseAlertFields(self):
        """Test ValidatingSortClauseAlertFields"""
