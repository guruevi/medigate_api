...
class ValidatingSimpleQueryFilterVulnerabilities(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingSimpleQueryFilterVulnerabilities:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingSimpleQueryFilterVulnerabilities:
        """Create an instance of ValidatingSimpleQueryFilterVulnerabilities from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingSimpleQueryFilterVulnerabilities.parse_obj(obj)

        _obj = ValidatingSimpleQueryFilterVulnerabilities.parse_obj({
            "field": obj.get("field"),
