...
class DevicesFilterBy(BaseModel):
    """
    DevicesFilterBy
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DevicesFilterBy:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DevicesFilterBy:
        """Create an instance of DevicesFilterBy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DevicesFilterBy.parse_obj(obj)

        _obj = DevicesFilterBy.parse_obj({
