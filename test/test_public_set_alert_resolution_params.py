...
from medigate_api.models.public_set_alert_resolution_params import PublicSetAlertResolutionParams  # noqa: E501

class TestPublicSetAlertResolutionParams(unittest.TestCase):
    """PublicSetAlertResolutionParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicSetAlertResolutionParams:
        """Test PublicSetAlertResolutionParams
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicSetAlertResolutionParams`
        """
        model = PublicSetAlertResolutionParams()  # noqa: E501
        if include_optional:
            return PublicSetAlertResolutionParams(
                alerts = medigate_api.models.target_alert_ids.TargetAlertIds(
                    alert_ids = [
                        56
                        ], ),
                devices = medigate_api.models.device_filter_by.DeviceFilterBy(
                    filter_by = null, ),
                status = 'resolved'
            )
        else:
    ...
    def testPublicSetAlertResolutionParams(self):
        """Test PublicSetAlertResolutionParams"""
