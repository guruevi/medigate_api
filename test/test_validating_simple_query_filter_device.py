...
from medigate_api.models.validating_simple_query_filter_device import ValidatingSimpleQueryFilterDevice  # noqa: E501

class TestValidatingSimpleQueryFilterDevice(unittest.TestCase):
    """ValidatingSimpleQueryFilterDevice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSimpleQueryFilterDevice:
        """Test ValidatingSimpleQueryFilterDevice
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSimpleQueryFilterDevice`
        """
        model = ValidatingSimpleQueryFilterDevice()  # noqa: E501
        if include_optional:
            return ValidatingSimpleQueryFilterDevice(
                field = '0',
                operation = '0',
                value = None
            )
    ...
    def testValidatingSimpleQueryFilterDevice(self):
        """Test ValidatingSimpleQueryFilterDevice"""
