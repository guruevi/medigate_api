...
from medigate_api.models.get_alerted_devices_response import GetAlertedDevicesResponse  # noqa: E501

class TestGetAlertedDevicesResponse(unittest.TestCase):
    """GetAlertedDevicesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAlertedDevicesResponse:
        """Test GetAlertedDevicesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAlertedDevicesResponse`
        """
        model = GetAlertedDevicesResponse()  # noqa: E501
        if include_optional:
            return GetAlertedDevicesResponse(
                devices = [
                    None
                    ],
                count = 56
    ...
    def testGetAlertedDevicesResponse(self):
        """Test GetAlertedDevicesResponse"""
