...
class VulnerabilitiesFilterBy(BaseModel):
    """
    VulnerabilitiesFilterBy
    """
    filter_by: FilterBy12 = Field(...)
    __properties = ["filter_by"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VulnerabilitiesFilterBy:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VulnerabilitiesFilterBy:
        """Create an instance of VulnerabilitiesFilterBy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VulnerabilitiesFilterBy.parse_obj(obj)

        _obj = VulnerabilitiesFilterBy.parse_obj({
            "filter_by": FilterBy12.from_dict(obj.get("filter_by")) if obj.get("filter_by") is not None else None
        })
        return _obj
