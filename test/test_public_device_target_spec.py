...
from medigate_api.models.public_device_target_spec import PublicDeviceTargetSpec  # noqa: E501

class TestPublicDeviceTargetSpec(unittest.TestCase):
    """PublicDeviceTargetSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicDeviceTargetSpec:
        """Test PublicDeviceTargetSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicDeviceTargetSpec`
        """
        model = PublicDeviceTargetSpec()  # noqa: E501
        if include_optional:
            return PublicDeviceTargetSpec(
                target_type = 'device',
                filter_by = None
            )
        else:
    ...
    def testPublicDeviceTargetSpec(self):
        """Test PublicDeviceTargetSpec"""
