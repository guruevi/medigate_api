...
FILTERBY3_ANY_OF_SCHEMAS = ["ValidatingCompoundQueryFilterDeviceAlert", "ValidatingSimpleQueryFilterDeviceAlert"]

class FilterBy3(BaseModel):
    """
    ...
    if TYPE_CHECKING:
        ...
        actual_instance: Any
    any_of_schemas: List[str] = Field(FILTERBY3_ANY_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in FilterBy3 with anyOf schemas: ValidatingCompoundQueryFilterDeviceAlert, ValidatingSimpleQueryFilterDeviceAlert. Details: " + ", ".join(error_messages))
        else:
            return v

    @classmethod
    def from_dict(cls, obj: dict) -> FilterBy3:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> FilterBy3:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into FilterBy3 with anyOf schemas: ValidatingCompoundQueryFilterDeviceAlert, ValidatingSimpleQueryFilterDeviceAlert. Details: " + ", ".join(error_messages))
        else:
            return instance
