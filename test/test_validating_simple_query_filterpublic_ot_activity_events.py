...
from medigate_api.models.validating_simple_query_filterpublic_ot_activity_events import ValidatingSimpleQueryFilterpublicOtActivityEvents  # noqa: E501

class TestValidatingSimpleQueryFilterpublicOtActivityEvents(unittest.TestCase):
    """ValidatingSimpleQueryFilterpublicOtActivityEvents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSimpleQueryFilterpublicOtActivityEvents:
        """Test ValidatingSimpleQueryFilterpublicOtActivityEvents
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSimpleQueryFilterpublicOtActivityEvents`
        """
        model = ValidatingSimpleQueryFilterpublicOtActivityEvents()  # noqa: E501
        if include_optional:
            return ValidatingSimpleQueryFilterpublicOtActivityEvents(
                field = '0',
                operation = '0',
                value = None
            )
    ...
    def testValidatingSimpleQueryFilterpublicOtActivityEvents(self):
        """Test ValidatingSimpleQueryFilterpublicOtActivityEvents"""
