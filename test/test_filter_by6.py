...
from medigate_api.models.filter_by6 import FilterBy6  # noqa: E501

class TestFilterBy6(unittest.TestCase):
    """FilterBy6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterBy6:
        """Test FilterBy6
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterBy6`
        """
        model = FilterBy6()  # noqa: E501
        if include_optional:
            return FilterBy6(
                field = None,
                operation = 'and',
