...
from medigate_api.models.validating_compound_query_filter_vulnerabilities_operands_inner import ValidatingCompoundQueryFilterVulnerabilitiesOperandsInner  # noqa: E501

class TestValidatingCompoundQueryFilterVulnerabilitiesOperandsInner(unittest.TestCase):
    """ValidatingCompoundQueryFilterVulnerabilitiesOperandsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterVulnerabilitiesOperandsInner:
        """Test ValidatingCompoundQueryFilterVulnerabilitiesOperandsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterVulnerabilitiesOperandsInner`
        """
        model = ValidatingCompoundQueryFilterVulnerabilitiesOperandsInner()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterVulnerabilitiesOperandsInner(
                field = None,
                operation = 'and',
                value = None,
                operands = None
    ...
    def testValidatingCompoundQueryFilterVulnerabilitiesOperandsInner(self):
        """Test ValidatingCompoundQueryFilterVulnerabilitiesOperandsInner"""
