...
class ServerInterfacesSortableFieldsEnum(str, Enum):
    """
    An enumeration.
    """
    ...
    INTERFACE_CONNECTION_TYPE = 'interface_connection_type'
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerInterfacesSortableFieldsEnum:
        """Create an instance of ServerInterfacesSortableFieldsEnum from a JSON string"""
        return ServerInterfacesSortableFieldsEnum(json.loads(json_str))
