...
class ValidatingSortClauseVulnerableDevice(BaseModel):
    """
    ValidatingSortClauseVulnerableDevice
    """
    field: VulnerableDeviceSortableFieldsEnum = Field(..., description="Name of field to sort by")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingSortClauseVulnerableDevice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingSortClauseVulnerableDevice:
        """Create an instance of ValidatingSortClauseVulnerableDevice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingSortClauseVulnerableDevice.parse_obj(obj)

        _obj = ValidatingSortClauseVulnerableDevice.parse_obj({
            "field": obj.get("field"),
            "order": obj.get("order")
        })
        return _obj
