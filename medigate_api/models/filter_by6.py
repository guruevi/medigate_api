...
FILTERBY6_ANY_OF_SCHEMAS = ["ValidatingCompoundQueryFilterpublicOtActivityEvents", "ValidatingSimpleQueryFilterpublicOtActivityEvents"]

class FilterBy6(BaseModel):
    """
    ...
    if TYPE_CHECKING:
        ...
        actual_instance: Any
    any_of_schemas: List[str] = Field(FILTERBY6_ANY_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in FilterBy6 with anyOf schemas: ValidatingCompoundQueryFilterpublicOtActivityEvents, ValidatingSimpleQueryFilterpublicOtActivityEvents. Details: " + ", ".join(error_messages))
        else:
            return v

    @classmethod
    def from_dict(cls, obj: dict) -> FilterBy6:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> FilterBy6:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into FilterBy6 with anyOf schemas: ValidatingCompoundQueryFilterpublicOtActivityEvents, ValidatingSimpleQueryFilterpublicOtActivityEvents. Details: " + ", ".join(error_messages))
        else:
            return instance
