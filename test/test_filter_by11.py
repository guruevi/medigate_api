...
from medigate_api.models.filter_by11 import FilterBy11  # noqa: E501

class TestFilterBy11(unittest.TestCase):
    """FilterBy11 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterBy11:
        """Test FilterBy11
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterBy11`
        """
        model = FilterBy11()  # noqa: E501
        if include_optional:
            return FilterBy11(
                field = None,
                operation = 'and',
