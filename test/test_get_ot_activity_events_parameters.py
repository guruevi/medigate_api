...
from medigate_api.models.get_ot_activity_events_parameters import GetOTActivityEventsParameters  # noqa: E501

class TestGetOTActivityEventsParameters(unittest.TestCase):
    """GetOTActivityEventsParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOTActivityEventsParameters:
        """Test GetOTActivityEventsParameters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOTActivityEventsParameters`
        """
        model = GetOTActivityEventsParameters()  # noqa: E501
        if include_optional:
            return GetOTActivityEventsParameters(
                filter_by = None,
                fields = [
                    'detection_time'
                    ],
    ...
    def testGetOTActivityEventsParameters(self):
        """Test GetOTActivityEventsParameters"""
