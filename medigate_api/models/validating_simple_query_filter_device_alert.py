...
class ValidatingSimpleQueryFilterDeviceAlert(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingSimpleQueryFilterDeviceAlert:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingSimpleQueryFilterDeviceAlert:
        """Create an instance of ValidatingSimpleQueryFilterDeviceAlert from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingSimpleQueryFilterDeviceAlert.parse_obj(obj)

        _obj = ValidatingSimpleQueryFilterDeviceAlert.parse_obj({
            "field": obj.get("field"),
