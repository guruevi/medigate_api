...
from medigate_api.models.validating_sort_clauseservers import ValidatingSortClauseservers  # noqa: E501

class TestValidatingSortClauseservers(unittest.TestCase):
    """ValidatingSortClauseservers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSortClauseservers:
        """Test ValidatingSortClauseservers
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSortClauseservers`
        """
        model = ValidatingSortClauseservers()  # noqa: E501
        if include_optional:
            return ValidatingSortClauseservers(
                field = 'server_name',
                order = 'asc'
            )
        else:
    ...
    def testValidatingSortClauseservers(self):
        """Test ValidatingSortClauseservers"""
