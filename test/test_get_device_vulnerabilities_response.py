...
from medigate_api.models.get_device_vulnerabilities_response import GetDeviceVulnerabilitiesResponse  # noqa: E501

class TestGetDeviceVulnerabilitiesResponse(unittest.TestCase):
    """GetDeviceVulnerabilitiesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDeviceVulnerabilitiesResponse:
        """Test GetDeviceVulnerabilitiesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDeviceVulnerabilitiesResponse`
        """
        model = GetDeviceVulnerabilitiesResponse()  # noqa: E501
        if include_optional:
            return GetDeviceVulnerabilitiesResponse(
    ...
    def testGetDeviceVulnerabilitiesResponse(self):
        """Test GetDeviceVulnerabilitiesResponse"""
