...
class CompoundQueryFilterOperation(str, Enum):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompoundQueryFilterOperation:
        """Create an instance of CompoundQueryFilterOperation from a JSON string"""
        return CompoundQueryFilterOperation(json.loads(json_str))
