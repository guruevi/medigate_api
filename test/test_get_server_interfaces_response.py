...
from medigate_api.models.get_server_interfaces_response import GetServerInterfacesResponse  # noqa: E501

class TestGetServerInterfacesResponse(unittest.TestCase):
    """GetServerInterfacesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetServerInterfacesResponse:
        """Test GetServerInterfacesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetServerInterfacesResponse`
        """
        model = GetServerInterfacesResponse()  # noqa: E501
        if include_optional:
            return GetServerInterfacesResponse(
                server_interfaces = [
                    None
                    ],
                count = 56
    ...
    def testGetServerInterfacesResponse(self):
        """Test GetServerInterfacesResponse"""
