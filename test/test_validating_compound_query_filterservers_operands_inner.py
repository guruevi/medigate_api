...
from medigate_api.models.validating_compound_query_filterservers_operands_inner import ValidatingCompoundQueryFilterserversOperandsInner  # noqa: E501

class TestValidatingCompoundQueryFilterserversOperandsInner(unittest.TestCase):
    """ValidatingCompoundQueryFilterserversOperandsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterserversOperandsInner:
        """Test ValidatingCompoundQueryFilterserversOperandsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterserversOperandsInner`
        """
        model = ValidatingCompoundQueryFilterserversOperandsInner()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterserversOperandsInner(
                field = None,
                operation = 'and',
                value = None,
                operands = None
    ...
    def testValidatingCompoundQueryFilterserversOperandsInner(self):
        """Test ValidatingCompoundQueryFilterserversOperandsInner"""
