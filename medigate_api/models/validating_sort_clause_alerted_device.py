...
class ValidatingSortClauseAlertedDevice(BaseModel):
    """
    ValidatingSortClauseAlertedDevice
    """
    field: AlertedDeviceSortableFieldsEnum = Field(..., description="Name of field to sort by")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingSortClauseAlertedDevice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingSortClauseAlertedDevice:
        """Create an instance of ValidatingSortClauseAlertedDevice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingSortClauseAlertedDevice.parse_obj(obj)

        _obj = ValidatingSortClauseAlertedDevice.parse_obj({
            "field": obj.get("field"),
            "order": obj.get("order")
        })
        return _obj
