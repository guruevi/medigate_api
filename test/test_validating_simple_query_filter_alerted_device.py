...
from medigate_api.models.validating_simple_query_filter_alerted_device import ValidatingSimpleQueryFilterAlertedDevice  # noqa: E501

class TestValidatingSimpleQueryFilterAlertedDevice(unittest.TestCase):
    """ValidatingSimpleQueryFilterAlertedDevice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSimpleQueryFilterAlertedDevice:
        """Test ValidatingSimpleQueryFilterAlertedDevice
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSimpleQueryFilterAlertedDevice`
        """
        model = ValidatingSimpleQueryFilterAlertedDevice()  # noqa: E501
        if include_optional:
            return ValidatingSimpleQueryFilterAlertedDevice(
                field = '0',
                operation = '0',
                value = None
            )
    ...
    def testValidatingSimpleQueryFilterAlertedDevice(self):
        """Test ValidatingSimpleQueryFilterAlertedDevice"""
