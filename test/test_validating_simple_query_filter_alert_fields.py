...
from medigate_api.models.validating_simple_query_filter_alert_fields import ValidatingSimpleQueryFilterAlertFields  # noqa: E501

class TestValidatingSimpleQueryFilterAlertFields(unittest.TestCase):
    """ValidatingSimpleQueryFilterAlertFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSimpleQueryFilterAlertFields:
        """Test ValidatingSimpleQueryFilterAlertFields
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSimpleQueryFilterAlertFields`
        """
        model = ValidatingSimpleQueryFilterAlertFields()  # noqa: E501
        if include_optional:
            return ValidatingSimpleQueryFilterAlertFields(
                field = '0',
                operation = '0',
                value = None
            )
    ...
    def testValidatingSimpleQueryFilterAlertFields(self):
        """Test ValidatingSimpleQueryFilterAlertFields"""
