...
class ValidatingCompoundQueryFilterAlertFields(BaseModel):
    """
    ...
    operands: conlist(ValidatingCompoundQueryFilterAlertFieldsOperandsInner) = Field(..., description="Other filters to join together using `operation`")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingCompoundQueryFilterAlertFields:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingCompoundQueryFilterAlertFields:
        """Create an instance of ValidatingCompoundQueryFilterAlertFields from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingCompoundQueryFilterAlertFields.parse_obj(obj)

        _obj = ValidatingCompoundQueryFilterAlertFields.parse_obj({
            "operation": obj.get("operation"),
            "operands": [ValidatingCompoundQueryFilterAlertFieldsOperandsInner.from_dict(_item) for _item in obj.get("operands")] if obj.get("operands") is not None else None
        })
        return _obj
...
ValidatingCompoundQueryFilterAlertFields.update_forward_refs()
