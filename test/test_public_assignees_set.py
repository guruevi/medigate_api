...
from medigate_api.models.public_assignees_set import PublicAssigneesSet  # noqa: E501

class TestPublicAssigneesSet(unittest.TestCase):
    """PublicAssigneesSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicAssigneesSet:
        """Test PublicAssigneesSet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicAssigneesSet`
        """
        model = PublicAssigneesSet()  # noqa: E501
        if include_optional:
            return PublicAssigneesSet(
    ...
    def testPublicAssigneesSet(self):
        """Test PublicAssigneesSet"""
