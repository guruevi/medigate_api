...
from medigate_api.models.target_alert_ids import TargetAlertIds  # noqa: E501

class TestTargetAlertIds(unittest.TestCase):
    """TargetAlertIds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TargetAlertIds:
        """Test TargetAlertIds
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TargetAlertIds`
        """
        model = TargetAlertIds()  # noqa: E501
        if include_optional:
            return TargetAlertIds(
                alert_ids = [
                    56
                    ]
            )
