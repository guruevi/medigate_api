...
from medigate_api.models.validating_simple_query_filter_vulnerable_device import ValidatingSimpleQueryFilterVulnerableDevice  # noqa: E501

class TestValidatingSimpleQueryFilterVulnerableDevice(unittest.TestCase):
    """ValidatingSimpleQueryFilterVulnerableDevice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSimpleQueryFilterVulnerableDevice:
        """Test ValidatingSimpleQueryFilterVulnerableDevice
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSimpleQueryFilterVulnerableDevice`
        """
        model = ValidatingSimpleQueryFilterVulnerableDevice()  # noqa: E501
        if include_optional:
            return ValidatingSimpleQueryFilterVulnerableDevice(
                field = '0',
                operation = '0',
                value = None
            )
    ...
    def testValidatingSimpleQueryFilterVulnerableDevice(self):
        """Test ValidatingSimpleQueryFilterVulnerableDevice"""
