...
from medigate_api.models.filter_by3 import FilterBy3  # noqa: E501

class TestFilterBy3(unittest.TestCase):
    """FilterBy3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterBy3:
        """Test FilterBy3
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterBy3`
        """
        model = FilterBy3()  # noqa: E501
        if include_optional:
            return FilterBy3(
                field = None,
                operation = 'and',
