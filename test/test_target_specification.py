...
from medigate_api.models.target_specification import TargetSpecification  # noqa: E501

class TestTargetSpecification(unittest.TestCase):
    """TargetSpecification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TargetSpecification:
        """Test TargetSpecification
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TargetSpecification`
        """
        model = TargetSpecification()  # noqa: E501
        if include_optional:
