...
from medigate_api.models.public_set_custom_attribute_params import PublicSetCustomAttributeParams  # noqa: E501

class TestPublicSetCustomAttributeParams(unittest.TestCase):
    """PublicSetCustomAttributeParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicSetCustomAttributeParams:
        """Test PublicSetCustomAttributeParams
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicSetCustomAttributeParams`
        """
        model = PublicSetCustomAttributeParams()  # noqa: E501
        if include_optional:
            return PublicSetCustomAttributeParams(
                target_specification = medigate_api.models.public_device_target_spec.PublicDeviceTargetSpec(
                    target_type = 'device', 
                    filter_by = null, ),
                custom_attribute_api_name = '',
                value = ''
            )
        else:
            return PublicSetCustomAttributeParams(
    ...
    def testPublicSetCustomAttributeParams(self):
        """Test PublicSetCustomAttributeParams"""
