...
from medigate_api.models.vulnerabilities_filter_by import VulnerabilitiesFilterBy  # noqa: E501

class TestVulnerabilitiesFilterBy(unittest.TestCase):
    """VulnerabilitiesFilterBy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VulnerabilitiesFilterBy:
        """Test VulnerabilitiesFilterBy
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VulnerabilitiesFilterBy`
        """
        model = VulnerabilitiesFilterBy()  # noqa: E501
        if include_optional:
            return VulnerabilitiesFilterBy(
                filter_by = None
            )
        else:
            return VulnerabilitiesFilterBy(
    ...
    def testVulnerabilitiesFilterBy(self):
        """Test VulnerabilitiesFilterBy"""
