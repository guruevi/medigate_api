...
class ValidatingSortClausepublicOtActivityEvents(BaseModel):
    """
    ValidatingSortClausepublicOtActivityEvents
    """
    field: PublicOtActivityEventsSortableFieldsEnum = Field(..., description="Name of field to sort by")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingSortClausepublicOtActivityEvents:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingSortClausepublicOtActivityEvents:
        """Create an instance of ValidatingSortClausepublicOtActivityEvents from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingSortClausepublicOtActivityEvents.parse_obj(obj)

        _obj = ValidatingSortClausepublicOtActivityEvents.parse_obj({
            "field": obj.get("field"),
            "order": obj.get("order")
        })
        return _obj
