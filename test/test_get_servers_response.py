...
from medigate_api.models.get_servers_response import GetServersResponse  # noqa: E501

class TestGetServersResponse(unittest.TestCase):
    """GetServersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetServersResponse:
        """Test GetServersResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetServersResponse`
        """
        model = GetServersResponse()  # noqa: E501
        if include_optional:
    ...
    def testGetServersResponse(self):
        """Test GetServersResponse"""
