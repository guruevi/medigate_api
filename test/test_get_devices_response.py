...
from medigate_api.models.get_devices_response import GetDevicesResponse  # noqa: E501

class TestGetDevicesResponse(unittest.TestCase):
    """GetDevicesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDevicesResponse:
        """Test GetDevicesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDevicesResponse`
        """
        model = GetDevicesResponse()  # noqa: E501
        if include_optional:
    ...
    def testGetDevicesResponse(self):
        """Test GetDevicesResponse"""
