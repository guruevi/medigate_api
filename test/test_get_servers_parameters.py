...
from medigate_api.models.get_servers_parameters import GetServersParameters  # noqa: E501

class TestGetServersParameters(unittest.TestCase):
    """GetServersParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetServersParameters:
        """Test GetServersParameters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetServersParameters`
        """
        model = GetServersParameters()  # noqa: E501
        if include_optional:
            return GetServersParameters(
                filter_by = None,
                fields = [
                    'server_name'
                    ],
    ...
    def testGetServersParameters(self):
        """Test GetServersParameters"""
