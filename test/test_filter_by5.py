...
from medigate_api.models.filter_by5 import FilterBy5  # noqa: E501

class TestFilterBy5(unittest.TestCase):
    """FilterBy5 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterBy5:
        """Test FilterBy5
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterBy5`
        """
        model = FilterBy5()  # noqa: E501
        if include_optional:
            return FilterBy5(
                field = None,
                operation = 'and',
