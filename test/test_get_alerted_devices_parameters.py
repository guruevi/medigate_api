...
from medigate_api.models.get_alerted_devices_parameters import GetAlertedDevicesParameters  # noqa: E501

class TestGetAlertedDevicesParameters(unittest.TestCase):
    """GetAlertedDevicesParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAlertedDevicesParameters:
        """Test GetAlertedDevicesParameters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAlertedDevicesParameters`
        """
        model = GetAlertedDevicesParameters()  # noqa: E501
        if include_optional:
            return GetAlertedDevicesParameters(
                filter_by = None,
                fields = [
                    'network_list'
                    ],
    ...
    def testGetAlertedDevicesParameters(self):
        """Test GetAlertedDevicesParameters"""
