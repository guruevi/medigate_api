...
from medigate_api.models.validating_compound_query_filterpublic_ot_activity_events_operands_inner import ValidatingCompoundQueryFilterpublicOtActivityEventsOperandsInner  # noqa: E501

class TestValidatingCompoundQueryFilterpublicOtActivityEventsOperandsInner(unittest.TestCase):
    """ValidatingCompoundQueryFilterpublicOtActivityEventsOperandsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterpublicOtActivityEventsOperandsInner:
        """Test ValidatingCompoundQueryFilterpublicOtActivityEventsOperandsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterpublicOtActivityEventsOperandsInner`
        """
        model = ValidatingCompoundQueryFilterpublicOtActivityEventsOperandsInner()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterpublicOtActivityEventsOperandsInner(
                field = None,
                operation = 'and',
                value = None,
                operands = None
    ...
    def testValidatingCompoundQueryFilterpublicOtActivityEventsOperandsInner(self):
        """Test ValidatingCompoundQueryFilterpublicOtActivityEventsOperandsInner"""
