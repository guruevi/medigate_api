...
from medigate_api.models.simple_query_filter import SimpleQueryFilter  # noqa: E501

class TestSimpleQueryFilter(unittest.TestCase):
    """SimpleQueryFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleQueryFilter:
        """Test SimpleQueryFilter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleQueryFilter`
        """
        model = SimpleQueryFilter()  # noqa: E501
        if include_optional:
    ...
    def testSimpleQueryFilter(self):
        """Test SimpleQueryFilter"""
