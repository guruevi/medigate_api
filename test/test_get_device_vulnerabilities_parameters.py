...
from medigate_api.models.get_device_vulnerabilities_parameters import GetDeviceVulnerabilitiesParameters  # noqa: E501

class TestGetDeviceVulnerabilitiesParameters(unittest.TestCase):
    """GetDeviceVulnerabilitiesParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDeviceVulnerabilitiesParameters:
        """Test GetDeviceVulnerabilitiesParameters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDeviceVulnerabilitiesParameters`
        """
        model = GetDeviceVulnerabilitiesParameters()  # noqa: E501
        if include_optional:
            return GetDeviceVulnerabilitiesParameters(
                filter_by = None,
                fields = [
                    'device_network_list'
                    ],
                sort_by = [
                    medigate_api.models.sort_clause.Sort Clause(
                        field = null, 
                        order = null, )
                    ],
                offset = 56,
    ...
    def testGetDeviceVulnerabilitiesParameters(self):
        """Test GetDeviceVulnerabilitiesParameters"""
