...
from medigate_api.models.validating_simple_query_filter_device_alert import ValidatingSimpleQueryFilterDeviceAlert  # noqa: E501

class TestValidatingSimpleQueryFilterDeviceAlert(unittest.TestCase):
    """ValidatingSimpleQueryFilterDeviceAlert unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSimpleQueryFilterDeviceAlert:
        """Test ValidatingSimpleQueryFilterDeviceAlert
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSimpleQueryFilterDeviceAlert`
        """
        model = ValidatingSimpleQueryFilterDeviceAlert()  # noqa: E501
        if include_optional:
            return ValidatingSimpleQueryFilterDeviceAlert(
                field = '0',
                operation = '0',
                value = None
            )
    ...
    def testValidatingSimpleQueryFilterDeviceAlert(self):
        """Test ValidatingSimpleQueryFilterDeviceAlert"""
