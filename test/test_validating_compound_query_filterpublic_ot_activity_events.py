...
from medigate_api.models.validating_compound_query_filterpublic_ot_activity_events import ValidatingCompoundQueryFilterpublicOtActivityEvents  # noqa: E501

class TestValidatingCompoundQueryFilterpublicOtActivityEvents(unittest.TestCase):
    """ValidatingCompoundQueryFilterpublicOtActivityEvents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterpublicOtActivityEvents:
        """Test ValidatingCompoundQueryFilterpublicOtActivityEvents
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterpublicOtActivityEvents`
        """
        model = ValidatingCompoundQueryFilterpublicOtActivityEvents()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterpublicOtActivityEvents(
                operation = 'and',
                operands = [
                    null
                    ]
    ...
    def testValidatingCompoundQueryFilterpublicOtActivityEvents(self):
        """Test ValidatingCompoundQueryFilterpublicOtActivityEvents"""
