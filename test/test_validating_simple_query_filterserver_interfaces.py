...
from medigate_api.models.validating_simple_query_filterserver_interfaces import ValidatingSimpleQueryFilterserverInterfaces  # noqa: E501

class TestValidatingSimpleQueryFilterserverInterfaces(unittest.TestCase):
    """ValidatingSimpleQueryFilterserverInterfaces unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSimpleQueryFilterserverInterfaces:
        """Test ValidatingSimpleQueryFilterserverInterfaces
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSimpleQueryFilterserverInterfaces`
        """
        model = ValidatingSimpleQueryFilterserverInterfaces()  # noqa: E501
        if include_optional:
            return ValidatingSimpleQueryFilterserverInterfaces(
                field = '0',
                operation = '0',
                value = None
            )
    ...
    def testValidatingSimpleQueryFilterserverInterfaces(self):
        """Test ValidatingSimpleQueryFilterserverInterfaces"""
