...
class ValidatingSimpleQueryFilterservers(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingSimpleQueryFilterservers:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingSimpleQueryFilterservers:
        """Create an instance of ValidatingSimpleQueryFilterservers from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingSimpleQueryFilterservers.parse_obj(obj)

        _obj = ValidatingSimpleQueryFilterservers.parse_obj({
            "field": obj.get("field"),
