...
class GetOTActivityEventsResponse(BaseModel):
    """
    GetOTActivityEventsResponse
    """
    ot_activity_events: conlist(Dict[str, Any]) = Field(...)
    count: Optional[StrictInt] = None
    __properties = ["ot_activity_events", "count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetOTActivityEventsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetOTActivityEventsResponse:
        """Create an instance of GetOTActivityEventsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetOTActivityEventsResponse.parse_obj(obj)

        _obj = GetOTActivityEventsResponse.parse_obj({
            "ot_activity_events": obj.get("ot_activity_events"),
            "count": obj.get("count")
        })
        return _obj
