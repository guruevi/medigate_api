...
from medigate_api.models.filter_by10 import FilterBy10  # noqa: E501

class TestFilterBy10(unittest.TestCase):
    """FilterBy10 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterBy10:
        """Test FilterBy10
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterBy10`
        """
        model = FilterBy10()  # noqa: E501
        if include_optional:
            return FilterBy10(
                field = None,
                operation = 'and',
