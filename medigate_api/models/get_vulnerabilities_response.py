...
class GetVulnerabilitiesResponse(BaseModel):
    ...
    """
    vulnerabilities: conlist(Dict[str, Any]) = Field(...)
    count: Optional[StrictInt] = None
    __properties = ["vulnerabilities", "count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetVulnerabilitiesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetVulnerabilitiesResponse:
        """Create an instance of GetVulnerabilitiesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetVulnerabilitiesResponse.parse_obj(obj)

        _obj = GetVulnerabilitiesResponse.parse_obj({
