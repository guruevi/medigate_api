...
from medigate_api.models.devices_filter_by import DevicesFilterBy  # noqa: E501

class TestDevicesFilterBy(unittest.TestCase):
    """DevicesFilterBy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DevicesFilterBy:
        """Test DevicesFilterBy
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DevicesFilterBy`
        """
        model = DevicesFilterBy()  # noqa: E501
        if include_optional:
            return DevicesFilterBy(
                filter_by = None
            )
        else:
            return DevicesFilterBy(
