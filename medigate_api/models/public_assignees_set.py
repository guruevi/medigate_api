...
class PublicAssigneesSet(BaseModel):
    """
    PublicAssigneesSet
    """
    target_specification: TargetSpecification = Field(...)
    usernames_to_add: Optional[conlist(StrictStr)] = None
    usernames_to_remove: Optional[conlist(StrictStr)] = None
    group_names_to_add: Optional[conlist(StrictStr)] = None
    group_names_to_remove: Optional[conlist(StrictStr)] = None
    __properties = ["target_specification", "usernames_to_add", "usernames_to_remove", "group_names_to_add", "group_names_to_remove"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicAssigneesSet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublicAssigneesSet:
        """Create an instance of PublicAssigneesSet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublicAssigneesSet.parse_obj(obj)

        _obj = PublicAssigneesSet.parse_obj({
            "target_specification": TargetSpecification.from_dict(obj.get("target_specification")) if obj.get("target_specification") is not None else None,
            "usernames_to_add": obj.get("usernames_to_add"),
            "usernames_to_remove": obj.get("usernames_to_remove"),
            "group_names_to_add": obj.get("group_names_to_add"),
            "group_names_to_remove": obj.get("group_names_to_remove")
        })
        return _obj
