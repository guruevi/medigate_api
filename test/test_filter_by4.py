...
from medigate_api.models.filter_by4 import FilterBy4  # noqa: E501

class TestFilterBy4(unittest.TestCase):
    """FilterBy4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterBy4:
        """Test FilterBy4
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterBy4`
        """
        model = FilterBy4()  # noqa: E501
        if include_optional:
            return FilterBy4(
                field = None,
                operation = 'and',
