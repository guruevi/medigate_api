...
from medigate_api.models.validating_simple_query_filterservers import ValidatingSimpleQueryFilterservers  # noqa: E501

class TestValidatingSimpleQueryFilterservers(unittest.TestCase):
    """ValidatingSimpleQueryFilterservers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSimpleQueryFilterservers:
        """Test ValidatingSimpleQueryFilterservers
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSimpleQueryFilterservers`
        """
        model = ValidatingSimpleQueryFilterservers()  # noqa: E501
        if include_optional:
            return ValidatingSimpleQueryFilterservers(
                field = '0',
                operation = '0',
                value = None
            )
    ...
    def testValidatingSimpleQueryFilterservers(self):
        """Test ValidatingSimpleQueryFilterservers"""
