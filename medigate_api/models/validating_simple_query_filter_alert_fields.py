...
class ValidatingSimpleQueryFilterAlertFields(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingSimpleQueryFilterAlertFields:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingSimpleQueryFilterAlertFields:
        """Create an instance of ValidatingSimpleQueryFilterAlertFields from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingSimpleQueryFilterAlertFields.parse_obj(obj)

        _obj = ValidatingSimpleQueryFilterAlertFields.parse_obj({
            "field": obj.get("field"),
