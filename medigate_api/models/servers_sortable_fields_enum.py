...
class ServersSortableFieldsEnum(str, Enum):
    """
    An enumeration.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServersSortableFieldsEnum:
        """Create an instance of ServersSortableFieldsEnum from a JSON string"""
        return ServersSortableFieldsEnum(json.loads(json_str))
