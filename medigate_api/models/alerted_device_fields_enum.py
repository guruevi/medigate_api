...
class AlertedDeviceFieldsEnum(str, Enum):
    """
    An enumeration.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertedDeviceFieldsEnum:
        """Create an instance of AlertedDeviceFieldsEnum from a JSON string"""
        return AlertedDeviceFieldsEnum(json.loads(json_str))
