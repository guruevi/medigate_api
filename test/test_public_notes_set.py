...
from medigate_api.models.public_notes_set import PublicNotesSet  # noqa: E501

class TestPublicNotesSet(unittest.TestCase):
    """PublicNotesSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicNotesSet:
        """Test PublicNotesSet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicNotesSet`
        """
        model = PublicNotesSet()  # noqa: E501
        if include_optional:
            return PublicNotesSet(
