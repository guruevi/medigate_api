...
from medigate_api.models.validating_compound_query_filter_vulnerable_device import ValidatingCompoundQueryFilterVulnerableDevice  # noqa: E501

class TestValidatingCompoundQueryFilterVulnerableDevice(unittest.TestCase):
    """ValidatingCompoundQueryFilterVulnerableDevice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterVulnerableDevice:
        """Test ValidatingCompoundQueryFilterVulnerableDevice
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterVulnerableDevice`
        """
        model = ValidatingCompoundQueryFilterVulnerableDevice()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterVulnerableDevice(
                operation = 'and',
                operands = [
                    null
                    ]
    ...
    def testValidatingCompoundQueryFilterVulnerableDevice(self):
        """Test ValidatingCompoundQueryFilterVulnerableDevice"""
