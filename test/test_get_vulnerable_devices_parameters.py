...
from medigate_api.models.get_vulnerable_devices_parameters import GetVulnerableDevicesParameters  # noqa: E501

class TestGetVulnerableDevicesParameters(unittest.TestCase):
    """GetVulnerableDevicesParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVulnerableDevicesParameters:
        """Test GetVulnerableDevicesParameters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVulnerableDevicesParameters`
        """
        model = GetVulnerableDevicesParameters()  # noqa: E501
        if include_optional:
            return GetVulnerableDevicesParameters(
                filter_by = None,
                fields = [
                    'network_list'
                    ],
    ...
    def testGetVulnerableDevicesParameters(self):
        """Test GetVulnerableDevicesParameters"""
