...
from medigate_api.models.validating_compound_query_filter_device_alert import ValidatingCompoundQueryFilterDeviceAlert  # noqa: E501

class TestValidatingCompoundQueryFilterDeviceAlert(unittest.TestCase):
    """ValidatingCompoundQueryFilterDeviceAlert unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterDeviceAlert:
        """Test ValidatingCompoundQueryFilterDeviceAlert
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterDeviceAlert`
        """
        model = ValidatingCompoundQueryFilterDeviceAlert()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterDeviceAlert(
                operation = 'and',
                operands = [
                    null
                    ]
    ...
    def testValidatingCompoundQueryFilterDeviceAlert(self):
        """Test ValidatingCompoundQueryFilterDeviceAlert"""
