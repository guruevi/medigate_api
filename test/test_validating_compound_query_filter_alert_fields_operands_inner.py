...
from medigate_api.models.validating_compound_query_filter_alert_fields_operands_inner import ValidatingCompoundQueryFilterAlertFieldsOperandsInner  # noqa: E501

class TestValidatingCompoundQueryFilterAlertFieldsOperandsInner(unittest.TestCase):
    """ValidatingCompoundQueryFilterAlertFieldsOperandsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterAlertFieldsOperandsInner:
        """Test ValidatingCompoundQueryFilterAlertFieldsOperandsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterAlertFieldsOperandsInner`
        """
        model = ValidatingCompoundQueryFilterAlertFieldsOperandsInner()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterAlertFieldsOperandsInner(
                field = None,
                operation = 'and',
                value = None,
                operands = None
    ...
    def testValidatingCompoundQueryFilterAlertFieldsOperandsInner(self):
        """Test ValidatingCompoundQueryFilterAlertFieldsOperandsInner"""
