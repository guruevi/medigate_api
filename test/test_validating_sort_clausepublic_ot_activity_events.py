...
from medigate_api.models.validating_sort_clausepublic_ot_activity_events import ValidatingSortClausepublicOtActivityEvents  # noqa: E501

class TestValidatingSortClausepublicOtActivityEvents(unittest.TestCase):
    """ValidatingSortClausepublicOtActivityEvents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSortClausepublicOtActivityEvents:
        """Test ValidatingSortClausepublicOtActivityEvents
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSortClausepublicOtActivityEvents`
        """
        model = ValidatingSortClausepublicOtActivityEvents()  # noqa: E501
        if include_optional:
            return ValidatingSortClausepublicOtActivityEvents(
    ...
    def testValidatingSortClausepublicOtActivityEvents(self):
        """Test ValidatingSortClausepublicOtActivityEvents"""
