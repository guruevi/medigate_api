...
from medigate_api.models.get_server_interfaces_parameters import GetServerInterfacesParameters  # noqa: E501

class TestGetServerInterfacesParameters(unittest.TestCase):
    """GetServerInterfacesParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetServerInterfacesParameters:
        """Test GetServerInterfacesParameters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetServerInterfacesParameters`
        """
        model = GetServerInterfacesParameters()  # noqa: E501
        if include_optional:
            return GetServerInterfacesParameters(
                filter_by = None,
                fields = [
                    'server_name'
                    ],
    ...
    def testGetServerInterfacesParameters(self):
        """Test GetServerInterfacesParameters"""
