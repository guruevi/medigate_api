...
from medigate_api.models.validating_sort_clause_alerted_device import ValidatingSortClauseAlertedDevice  # noqa: E501

class TestValidatingSortClauseAlertedDevice(unittest.TestCase):
    """ValidatingSortClauseAlertedDevice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSortClauseAlertedDevice:
        """Test ValidatingSortClauseAlertedDevice
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSortClauseAlertedDevice`
        """
        model = ValidatingSortClauseAlertedDevice()  # noqa: E501
        if include_optional:
            return ValidatingSortClauseAlertedDevice(
                field = 'network_list',
                order = 'asc'
            )
        else:
    ...
    def testValidatingSortClauseAlertedDevice(self):
        """Test ValidatingSortClauseAlertedDevice"""
