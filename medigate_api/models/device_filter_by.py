...
class DeviceFilterBy(BaseModel):
    """
    DeviceFilterBy
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeviceFilterBy:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeviceFilterBy:
        """Create an instance of DeviceFilterBy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeviceFilterBy.parse_obj(obj)

        _obj = DeviceFilterBy.parse_obj({
