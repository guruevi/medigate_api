...
class ValidatingSortClauseDeviceAlert(BaseModel):
    """
    ValidatingSortClauseDeviceAlert
    """
    field: DeviceAlertSortableFieldsEnum = Field(..., description="Name of field to sort by")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingSortClauseDeviceAlert:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingSortClauseDeviceAlert:
        """Create an instance of ValidatingSortClauseDeviceAlert from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingSortClauseDeviceAlert.parse_obj(obj)

        _obj = ValidatingSortClauseDeviceAlert.parse_obj({
            "field": obj.get("field"),
            "order": obj.get("order")
        })
        return _obj
