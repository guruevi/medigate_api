...
from medigate_api.models.public_alert_target_spec import PublicAlertTargetSpec  # noqa: E501

class TestPublicAlertTargetSpec(unittest.TestCase):
    """PublicAlertTargetSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicAlertTargetSpec:
        """Test PublicAlertTargetSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicAlertTargetSpec`
        """
        model = PublicAlertTargetSpec()  # noqa: E501
        if include_optional:
            return PublicAlertTargetSpec(
                target_type = 'alert',
                alert_ids = [
                    56
                    ]
    ...
    def testPublicAlertTargetSpec(self):
        """Test PublicAlertTargetSpec"""
