...
class ValidatingSimpleQueryFilterserverInterfaces(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingSimpleQueryFilterserverInterfaces:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingSimpleQueryFilterserverInterfaces:
        """Create an instance of ValidatingSimpleQueryFilterserverInterfaces from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingSimpleQueryFilterserverInterfaces.parse_obj(obj)

        _obj = ValidatingSimpleQueryFilterserverInterfaces.parse_obj({
            "field": obj.get("field"),
