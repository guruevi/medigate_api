...
from medigate_api.models.validating_compound_query_filter_vulnerabilities import ValidatingCompoundQueryFilterVulnerabilities  # noqa: E501

class TestValidatingCompoundQueryFilterVulnerabilities(unittest.TestCase):
    """ValidatingCompoundQueryFilterVulnerabilities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterVulnerabilities:
        """Test ValidatingCompoundQueryFilterVulnerabilities
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterVulnerabilities`
        """
        model = ValidatingCompoundQueryFilterVulnerabilities()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterVulnerabilities(
                operation = 'and',
                operands = [
                    null
                    ]
    ...
    def testValidatingCompoundQueryFilterVulnerabilities(self):
        """Test ValidatingCompoundQueryFilterVulnerabilities"""
