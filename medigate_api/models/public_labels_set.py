...
class PublicLabelsSet(BaseModel):
    """
    PublicLabelsSet
    """
    target_specification: TargetSpecification = Field(...)
    labels_to_add: Optional[conlist(StrictStr)] = None
    labels_to_remove: Optional[conlist(StrictStr)] = None
    __properties = ["target_specification", "labels_to_add", "labels_to_remove"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicLabelsSet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublicLabelsSet:
        """Create an instance of PublicLabelsSet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublicLabelsSet.parse_obj(obj)

        _obj = PublicLabelsSet.parse_obj({
            ...
            "labels_to_add": obj.get("labels_to_add"),
            "labels_to_remove": obj.get("labels_to_remove")
        })
        return _obj
