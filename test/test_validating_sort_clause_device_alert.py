...
from medigate_api.models.validating_sort_clause_device_alert import ValidatingSortClauseDeviceAlert  # noqa: E501

class TestValidatingSortClauseDeviceAlert(unittest.TestCase):
    """ValidatingSortClauseDeviceAlert unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSortClauseDeviceAlert:
        """Test ValidatingSortClauseDeviceAlert
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSortClauseDeviceAlert`
        """
        model = ValidatingSortClauseDeviceAlert()  # noqa: E501
        if include_optional:
            return ValidatingSortClauseDeviceAlert(
                field = 'device_uid',
                order = 'asc'
            )
        else:
    ...
    def testValidatingSortClauseDeviceAlert(self):
        """Test ValidatingSortClauseDeviceAlert"""
