...
from medigate_api.models.filter_by8 import FilterBy8  # noqa: E501

class TestFilterBy8(unittest.TestCase):
    """FilterBy8 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterBy8:
        """Test FilterBy8
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterBy8`
        """
        model = FilterBy8()  # noqa: E501
        if include_optional:
            return FilterBy8(
                field = None,
                operation = 'and',
