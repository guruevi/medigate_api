...
from medigate_api.models.validating_compound_query_filter_vulnerable_device_operands_inner import ValidatingCompoundQueryFilterVulnerableDeviceOperandsInner  # noqa: E501

class TestValidatingCompoundQueryFilterVulnerableDeviceOperandsInner(unittest.TestCase):
    """ValidatingCompoundQueryFilterVulnerableDeviceOperandsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterVulnerableDeviceOperandsInner:
        """Test ValidatingCompoundQueryFilterVulnerableDeviceOperandsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterVulnerableDeviceOperandsInner`
        """
        model = ValidatingCompoundQueryFilterVulnerableDeviceOperandsInner()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterVulnerableDeviceOperandsInner(
                field = None,
                operation = 'and',
                value = None,
                operands = None
    ...
    def testValidatingCompoundQueryFilterVulnerableDeviceOperandsInner(self):
        """Test ValidatingCompoundQueryFilterVulnerableDeviceOperandsInner"""
