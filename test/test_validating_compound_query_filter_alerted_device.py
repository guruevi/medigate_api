...
from medigate_api.models.validating_compound_query_filter_alerted_device import ValidatingCompoundQueryFilterAlertedDevice  # noqa: E501

class TestValidatingCompoundQueryFilterAlertedDevice(unittest.TestCase):
    """ValidatingCompoundQueryFilterAlertedDevice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterAlertedDevice:
        """Test ValidatingCompoundQueryFilterAlertedDevice
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterAlertedDevice`
        """
        model = ValidatingCompoundQueryFilterAlertedDevice()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterAlertedDevice(
                operation = 'and',
                operands = [
                    null
                    ]
    ...
    def testValidatingCompoundQueryFilterAlertedDevice(self):
        """Test ValidatingCompoundQueryFilterAlertedDevice"""
