...
from medigate_api.models.get_device_alerts_parameters import GetDeviceAlertsParameters  # noqa: E501

class TestGetDeviceAlertsParameters(unittest.TestCase):
    """GetDeviceAlertsParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDeviceAlertsParameters:
        """Test GetDeviceAlertsParameters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDeviceAlertsParameters`
        """
        model = GetDeviceAlertsParameters()  # noqa: E501
        if include_optional:
            return GetDeviceAlertsParameters(
                filter_by = None,
                fields = [
                    'device_uid'
                    ],
    ...
    def testGetDeviceAlertsParameters(self):
        """Test GetDeviceAlertsParameters"""
