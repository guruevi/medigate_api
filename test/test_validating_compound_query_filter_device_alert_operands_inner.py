...
from medigate_api.models.validating_compound_query_filter_device_alert_operands_inner import ValidatingCompoundQueryFilterDeviceAlertOperandsInner  # noqa: E501

class TestValidatingCompoundQueryFilterDeviceAlertOperandsInner(unittest.TestCase):
    """ValidatingCompoundQueryFilterDeviceAlertOperandsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterDeviceAlertOperandsInner:
        """Test ValidatingCompoundQueryFilterDeviceAlertOperandsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterDeviceAlertOperandsInner`
        """
        model = ValidatingCompoundQueryFilterDeviceAlertOperandsInner()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterDeviceAlertOperandsInner(
                field = None,
                operation = 'and',
                value = None,
                operands = None
    ...
    def testValidatingCompoundQueryFilterDeviceAlertOperandsInner(self):
        """Test ValidatingCompoundQueryFilterDeviceAlertOperandsInner"""
