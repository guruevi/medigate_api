...
class GetDevicesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDevicesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDevicesResponse:
        """Create an instance of GetDevicesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDevicesResponse.parse_obj(obj)

        _obj = GetDevicesResponse.parse_obj({
