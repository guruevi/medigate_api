...
class ValidatingCompoundQueryFilterpublicOtActivityEvents(BaseModel):
    """
    ...
    operands: conlist(ValidatingCompoundQueryFilterpublicOtActivityEventsOperandsInner) = Field(..., description="Other filters to join together using `operation`")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingCompoundQueryFilterpublicOtActivityEvents:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingCompoundQueryFilterpublicOtActivityEvents:
        """Create an instance of ValidatingCompoundQueryFilterpublicOtActivityEvents from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingCompoundQueryFilterpublicOtActivityEvents.parse_obj(obj)

        _obj = ValidatingCompoundQueryFilterpublicOtActivityEvents.parse_obj({
            "operation": obj.get("operation"),
            "operands": [ValidatingCompoundQueryFilterpublicOtActivityEventsOperandsInner.from_dict(_item) for _item in obj.get("operands")] if obj.get("operands") is not None else None
        })
        return _obj
...
ValidatingCompoundQueryFilterpublicOtActivityEvents.update_forward_refs()
