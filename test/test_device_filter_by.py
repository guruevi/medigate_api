...
from medigate_api.models.device_filter_by import DeviceFilterBy  # noqa: E501

class TestDeviceFilterBy(unittest.TestCase):
    """DeviceFilterBy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceFilterBy:
        """Test DeviceFilterBy
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceFilterBy`
        """
        model = DeviceFilterBy()  # noqa: E501
        if include_optional:
            return DeviceFilterBy(
                filter_by = None
            )
        else:
            return DeviceFilterBy(
