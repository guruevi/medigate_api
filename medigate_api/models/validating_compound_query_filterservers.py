...
class ValidatingCompoundQueryFilterservers(BaseModel):
    """
    ...
    operands: conlist(ValidatingCompoundQueryFilterserversOperandsInner) = Field(..., description="Other filters to join together using `operation`")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingCompoundQueryFilterservers:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingCompoundQueryFilterservers:
        """Create an instance of ValidatingCompoundQueryFilterservers from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingCompoundQueryFilterservers.parse_obj(obj)

        _obj = ValidatingCompoundQueryFilterservers.parse_obj({
            "operation": obj.get("operation"),
            "operands": [ValidatingCompoundQueryFilterserversOperandsInner.from_dict(_item) for _item in obj.get("operands")] if obj.get("operands") is not None else None
        })
        return _obj
...
ValidatingCompoundQueryFilterservers.update_forward_refs()
