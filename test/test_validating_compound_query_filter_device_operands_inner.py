...
from medigate_api.models.validating_compound_query_filter_device_operands_inner import ValidatingCompoundQueryFilterDeviceOperandsInner  # noqa: E501

class TestValidatingCompoundQueryFilterDeviceOperandsInner(unittest.TestCase):
    """ValidatingCompoundQueryFilterDeviceOperandsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingCompoundQueryFilterDeviceOperandsInner:
        """Test ValidatingCompoundQueryFilterDeviceOperandsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingCompoundQueryFilterDeviceOperandsInner`
        """
        model = ValidatingCompoundQueryFilterDeviceOperandsInner()  # noqa: E501
        if include_optional:
            return ValidatingCompoundQueryFilterDeviceOperandsInner(
                field = None,
                operation = 'and',
                value = None,
                operands = None
    ...
    def testValidatingCompoundQueryFilterDeviceOperandsInner(self):
        """Test ValidatingCompoundQueryFilterDeviceOperandsInner"""
