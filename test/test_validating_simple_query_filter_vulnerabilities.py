...
from medigate_api.models.validating_simple_query_filter_vulnerabilities import ValidatingSimpleQueryFilterVulnerabilities  # noqa: E501

class TestValidatingSimpleQueryFilterVulnerabilities(unittest.TestCase):
    """ValidatingSimpleQueryFilterVulnerabilities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatingSimpleQueryFilterVulnerabilities:
        """Test ValidatingSimpleQueryFilterVulnerabilities
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatingSimpleQueryFilterVulnerabilities`
        """
        model = ValidatingSimpleQueryFilterVulnerabilities()  # noqa: E501
        if include_optional:
            return ValidatingSimpleQueryFilterVulnerabilities(
                field = '0',
                operation = '0',
                value = None
            )
    ...
    def testValidatingSimpleQueryFilterVulnerabilities(self):
        """Test ValidatingSimpleQueryFilterVulnerabilities"""
