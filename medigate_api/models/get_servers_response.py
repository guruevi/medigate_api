...
class GetServersResponse(BaseModel):
    ...
    GetServersResponse
    """
    servers: conlist(Dict[str, Any]) = Field(...)
    count: Optional[StrictInt] = None
    __properties = ["servers", "count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetServersResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetServersResponse:
        """Create an instance of GetServersResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetServersResponse.parse_obj(obj)

        _obj = GetServersResponse.parse_obj({
