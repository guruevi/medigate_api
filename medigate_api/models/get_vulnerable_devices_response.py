...
class GetVulnerableDevicesResponse(BaseModel):
    """
    GetVulnerableDevicesResponse
    """
    devices: conlist(Dict[str, Any]) = Field(...)
    count: Optional[StrictInt] = None
    __properties = ["devices", "count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetVulnerableDevicesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetVulnerableDevicesResponse:
        """Create an instance of GetVulnerableDevicesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetVulnerableDevicesResponse.parse_obj(obj)

        _obj = GetVulnerableDevicesResponse.parse_obj({
