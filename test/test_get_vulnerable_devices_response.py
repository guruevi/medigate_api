...
from medigate_api.models.get_vulnerable_devices_response import GetVulnerableDevicesResponse  # noqa: E501

class TestGetVulnerableDevicesResponse(unittest.TestCase):
    """GetVulnerableDevicesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVulnerableDevicesResponse:
        """Test GetVulnerableDevicesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVulnerableDevicesResponse`
        """
        model = GetVulnerableDevicesResponse()  # noqa: E501
        if include_optional:
            return GetVulnerableDevicesResponse(
                devices = [
                    None
                    ],
                count = 56
    ...
    def testGetVulnerableDevicesResponse(self):
        """Test GetVulnerableDevicesResponse"""
