...
class CompoundQueryFilter(BaseModel):
    """
    ...
    operands: conlist(CompoundQueryFilterOperandsInner) = Field(..., description="Other filters to join together using `operation`")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompoundQueryFilter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CompoundQueryFilter:
        """Create an instance of CompoundQueryFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CompoundQueryFilter.parse_obj(obj)

        _obj = CompoundQueryFilter.parse_obj({
            "operation": obj.get("operation"),
            "operands": [CompoundQueryFilterOperandsInner.from_dict(_item) for _item in obj.get("operands")] if obj.get("operands") is not None else None
        })
        return _obj

from medigate_api.models.compound_query_filter_operands_inner import CompoundQueryFilterOperandsInner
CompoundQueryFilter.update_forward_refs()
