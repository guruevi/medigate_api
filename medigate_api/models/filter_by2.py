...
FILTERBY2_ANY_OF_SCHEMAS = ["ValidatingCompoundQueryFilterAlertFields", "ValidatingSimpleQueryFilterAlertFields"]

class FilterBy2(BaseModel):
    """
    ...
    if TYPE_CHECKING:
        ...
        actual_instance: Any
    any_of_schemas: List[str] = Field(FILTERBY2_ANY_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in FilterBy2 with anyOf schemas: ValidatingCompoundQueryFilterAlertFields, ValidatingSimpleQueryFilterAlertFields. Details: " + ", ".join(error_messages))
        else:
            return v

    @classmethod
    def from_dict(cls, obj: dict) -> FilterBy2:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> FilterBy2:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into FilterBy2 with anyOf schemas: ValidatingCompoundQueryFilterAlertFields, ValidatingSimpleQueryFilterAlertFields. Details: " + ", ".join(error_messages))
        else:
            return instance
