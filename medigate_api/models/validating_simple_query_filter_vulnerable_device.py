...
class ValidatingSimpleQueryFilterVulnerableDevice(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidatingSimpleQueryFilterVulnerableDevice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidatingSimpleQueryFilterVulnerableDevice:
        """Create an instance of ValidatingSimpleQueryFilterVulnerableDevice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidatingSimpleQueryFilterVulnerableDevice.parse_obj(obj)

        _obj = ValidatingSimpleQueryFilterVulnerableDevice.parse_obj({
            "field": obj.get("field"),
