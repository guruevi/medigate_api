...
class PublicAlertStatus(str, Enum):
    """
    An enumeration.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicAlertStatus:
        """Create an instance of PublicAlertStatus from a JSON string"""
        return PublicAlertStatus(json.loads(json_str))
